...
class FormInputJaket extends StatefulWidget {
  @override
  _FormInputJaketState createState() => _FormInputJaketState();
}

class _FormInputJaketState extends State<FormInputJaket> {
  ...
  Future saveUpload() async {
    ...
    final response = await http.post(Uri.parse("http://192.168.1.8:80/api/jakets"), body: {
