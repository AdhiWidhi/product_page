...
class DetailScreenCelana extends StatefulWidget {
  const DetailScreenCelana({Key key}) : super(key: key);

  @override
  _DetailScreenCelanaState createState() => _DetailScreenCelanaState();
}

class _DetailScreenCelanaState extends State<DetailScreenCelana> {
  final String url = "http://192.168.1.8:80/api/celanas";
  ...
  Future deleteData(String dataId) async {
    final String url = "http://192.168.1.8:80/api/celanas/" + dataId;
