...
class DetailScreenSepatu extends StatefulWidget {
  const DetailScreenSepatu({Key key}) : super(key: key);

  @override
  _DetailScreenSepatuState createState() => _DetailScreenSepatuState();
}

class _DetailScreenSepatuState extends State<DetailScreenSepatu> {
  final String url = "http://192.168.1.8:80/api/sepatus";
  ...
  Future deleteData(String dataId) async {
    final String url = "http://192.168.1.8:80/api/sepatus/" + dataId;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Pants', style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.bold)),
        actions: [
          Padding(
              padding: const EdgeInsets.only(right: 10), child: Icon(Icons.shopping_cart_outlined)),
        ],
      ),
