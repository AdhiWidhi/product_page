...
class DetailScreenJaket extends StatefulWidget {
  const DetailScreenJaket({Key key}) : super(key: key);

  @override
  _DetailScreenJakceState createState() => _DetailScreenJakceState();
}

class _DetailScreenJakceState extends State<DetailScreenJaket> {
  final String url = "http://192.168.1.8:80/api/jackets";
  ...
  Future deleteData(String dataId) async {
    final String url = "http://192.168.1.8:80/api/jackets/" + dataId;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            Text('Jackets', style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.bold)),
        actions: [
          Padding(
