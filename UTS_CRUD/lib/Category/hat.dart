...
class DetailScreenTopi extends StatefulWidget {
  const DetailScreenTopi({Key key}) : super(key: key);

  @override
  _DetailScreenTopiState createState() => _DetailScreenTopiState();
}

class _DetailScreenTopiState extends State<DetailScreenTopi> {
  final String url = "http://192.168.1.8:80/api/topis";
  ...
  Future deleteData(String dataId) async {
    final String url = "http://192.168.1.8:80/api/topis/" + dataId;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Hat', style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.bold)),
        actions: [
          Padding(
