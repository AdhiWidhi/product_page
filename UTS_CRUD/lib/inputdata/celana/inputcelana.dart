...
class FormInputCelana extends StatefulWidget {
  @override
  _FormInputCelanaState createState() => _FormInputCelanaState();
}

class _FormInputCelanaState extends State<FormInputCelana> {
  ...
  Future saveUpload() async {
    ...
    final response = await http.post(Uri.parse("http://192.168.1.8:80/api/celanas"), body: {
