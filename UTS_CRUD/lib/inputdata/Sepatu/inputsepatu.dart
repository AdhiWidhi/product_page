...
class FormInputSepatu extends StatefulWidget {
  @override
  _FormInputSepatuState createState() => _FormInputSepatuState();
}

class _FormInputSepatuState extends State<FormInputSepatu> {
  ...
  Future saveUpload() async {
    ...
    final response = await http.post(Uri.parse("http://192.168.1.8:80/api/sepatus"), body: {
